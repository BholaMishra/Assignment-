...
export default function Invoice() {
  ...
  useEffect(() => {
    dispatch(
      getClientsOfUser(
        user?.result._id || user?.result.googleId || user?.existedUser._id
      )
    );
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    if (invoice) {
      // if invoice is already present , then just update it
      dispatch(
      ...
      const { data } = await axios.post(
        "https://apnakhata01.herokuapp.com/records",
        {
          ...invoiceData,
          subTotal: subTotal,
          total: total,
            ...
            >
              ...
              <Grid item>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  <InputBase
                    defaultValue={invoiceData.recordNumber}
