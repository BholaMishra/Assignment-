    ...
    <>
      <div>
        <Dialog open={open} onClose={() => setOpen(false)}>
          <DialogTitle
            style={{ backgroundColor: "#905AD3", color: "whitesmoke" }}
          >
            {client === undefined ? "New Customer" : "Edit Customer details"}
          </DialogTitle>
          ...
          <DialogActions>
            <Button
              ...
              variant="contained"
              style={{ backgroundColor: "#905AD3" }}
            >
              {client === undefined ? "Save Customer" : "Edit Customer"}
            </Button>
          </DialogActions>
        </Dialog>
      </div>
