...
const InvoiceDetails = () => {
  ...
  const downLoadClick = () => {
    ...
    axios
      .post(`https://apnakhata01.herokuapp.com/create-pdf`, {
      ...
      .then(() =>
        axios.get("https://apnakhata01.herokuapp.com/get-pdf", {
          responseType: "blob",
        })
      )
      .then((res) => {
  ...
  const sendInvoice = () => {
    ...
    axios
      .post("https://apnakhata01.herokuapp.com/send-pdf", {
        name: invoice?.client?.name,
        address: invoice?.client?.address,
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ padding: "3%", marginLeft: "80px" }}
        >
          ...
          {open && (
            <AddPayment open={open} setOpen={setOpen} invoice={invoice} />
          )}
          ...
          <div style={{ marginTop: "10%" }} className="invoiceLayout">
            ...
            >
              ...
              <Grid item style={{ marginRight: 40, textAlign: "right" }}>
                ...
                >
                  {Number(total - totalPaid) <= 0 ? "Receipt" : type}
                </Typography>
                <Typography variant="overline" style={{ color: "gray" }}>
                  No:{" "}
                </Typography>
                <Typography variant="body2">
                  {invoiceData?.recordNumber}
                </Typography>
              </Grid>
            </Grid>
            ...
            <div className="itemsContainer">
              ...
              <div className="invoiceSummary" style={{ marginBottom: "5%" }}>
                ...
                <div className={"summaryItem"}>
                  <p>Paid</p>
                  <h4>
                    {currency} {parseFloat(totalPaid).toFixed(2)}
                  </h4>
                </div>
                ...
                <div className={"summaryItem"}>
                  ...
                  >
                    {currency} {parseFloat(total - totalPaid).toFixed(2)}
                  </h4>
                </div>
              </div>
